Shader "paintmap"
{
    Properties
    {
        ...
        _PaintMapWriteColor ("Color", Color) = (0,0,0,0)
    ...
    SubShader
    {
	    ...
	    struct VertexOut
			...
			VertexOut vert(	appdata v){
                ...
                o.pos=fixed4((o.uv[0].xy-float2(.5,.5))*float2(2,-2), 1, 1);
            ...
            {			
				...
				*/
                ...
                return _PaintMapWriteColor*_WriteAmmount;
            } 
            ENDCG
        }
    }
